      ...
      body: SingleChildScrollView(
      	child: Container(
	        child: Column(
              ...
              style: ButtonStyle(
                backgroundColor: MaterialStateProperty.all<Color>(const Color.fromRGBO(143, 148, 251,1)), // Set the button color to blue
                minimumSize: MaterialStateProperty.all<Size>(Size(150.0, 50.0)), // Set the button size
              ),
            ),
            SizedBox(height: 10),
            Text("Already have an account?", style: TextStyle(color: const Color.fromARGB(222, 158, 158, 158))),
            TextButton(
              onPressed: () {
                Navigator.pushNamed(context, '/login');
              },
